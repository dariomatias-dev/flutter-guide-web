...
const stats = [
  { icon: ShieldCheck, value: "97.8%", label: "Line Coverage" },
  { icon: FlaskConical, value: "378", label: "Test Cases" },
  { icon: GitBranch, value: "MIT", label: "Open Source License" },
];
    ...
    <section id="quality" className="w-full px-4 py-20 sm:px-8 md:py-28">
      <div className="mx-auto max-w-5xl text-center">
        ...
        >
          ...
          >
            Real engineering, not just marketing claims — see for yourself on GitHub.
          </motion.p>
        </motion.div>
